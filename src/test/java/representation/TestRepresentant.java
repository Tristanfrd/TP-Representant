...
public class TestRepresentant {
	...
	public void testCAParDefaut() {
		...
		assertEquals(FIXE_BASTIDE + INDEMNITE_OCCITANIE,salaire,0.001,"Le CA n'est pas correctement initialisé");
	}
	...
	public void testCAMoisIncorrect(){
            try{
                ...
                fail("Un mois incorrect doit générer une exception");
            }catch(IllegalArgumentException e){
        ...
        @Test
	public void testSalaireMoisIncorrect(){
            try{
        ...
        @Test
	public void testSalairePourcentageNegatif(){
            try{
               r.salaireMensuel(0, -0.1f);
               fail("Un pourcentage négatif doit renvoyer une exception.");
            }catch(IllegalArgumentException e){
